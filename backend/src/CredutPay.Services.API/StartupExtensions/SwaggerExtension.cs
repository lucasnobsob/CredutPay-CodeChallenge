    ...
    public static class SwaggerExtension
    {
            ...
            if (env.IsDevelopment())
            {
                services.AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("v1", new OpenApiInfo
                    {
                        ...
                        License = new OpenApiLicense() { Name = "GNU", Url = new Uri("https://github.com/lucasnobsob/CredutPay-CodeChallenge/blob/main/LICENSE") }
                    });
        ...
        public static IApplicationBuilder UseCustomizedSwagger(this IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "CredutPay Code Challenge API");
                });
            }
